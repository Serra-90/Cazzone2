...
f)
Come nome copiare e incollare .github/workflows/updatedomain.yml (il punto all’inizio deve essere compreso, e il nome deve essere tutto attaccato, nessuno spazio)
g)
